export const TERMS_SECTIONS = [
  ...
  },
  {
    ...
    body: `Para hacer uso del servicio, el usuario debe rellenar el formulario en esta página, indicando los datos personales necesarios y adjuntando un comprobante de domicilio requerido en caso de que los datos registrados en la UCU no coincidan con la residencia actual. El envío de la solicitud tiene como fecha límite la tercera semana del semestre y se obtendrá la aprobación de Bedelías en un plazo máximo de una semana tras enviada la solicitud.`,
  },
  {
  ...
  },
  {
    ...
    body: `Al solicitar el servicio, el usuario reconoce los riesgos existentes de andar en bicicleta. La universidad no será responsable por accidentes derivados del uso indebido de la bicicleta o fuera del ámbito universitario.`,
  },
];

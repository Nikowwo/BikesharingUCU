  ...
  return (
    <AppLayout className="!pt-0">
      <section className="relative min-h-screen hero-campus flex flex-col items-center justify-center text-center text-white">
        <h1 className="font-asap font-bold text-3xl md:text-5xl max-w-3xl px-6 leading-tight">
      ...
      <section className="bg-ucu-navy text-white py-16 px-6">
        <div className="max-w-5xl mx-auto grid md:grid-cols-2 gap-12 items-center">
          ...
          <div>
            <h2 className="font-asap font-bold text-xl mb-3">BikeShare UCU te ofrece lo que buscás.</h2>
      ...
      >
        <div className="max-w-xl mx-auto w-full py-6 md:py-8">
          <h2 className="font-asap font-bold text-2xl md:text-3xl text-center mb-8">Alquilá tu bici acá</h2>
